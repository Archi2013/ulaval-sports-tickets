...
=======
	...
	<h2>${pageTitle}</h2>
	<form:form action="/admin/ajout-billets-general" method="POST"
		class="margin-25 form-admin">
		<form:label path="sportName"> Sport : </form:label>
		<form:select path="sportName">
			<form:option value="${sportName}"> ${sportName} </form:option>
		</form:select>
		<br>
		<form:label path="gameDate">Match : </form:label>
		<form:select path="gameDate">
		...
		<br>
		<form:label path="numberOfTickets">Nombre de billets : </form:label>
	...
	<%@include file="../layout/footer.jsp"%>
>>>>>>> branch 'master' of https://github.com/Archi2013/ulaval-sports-tickets.git
</body>
</html>
