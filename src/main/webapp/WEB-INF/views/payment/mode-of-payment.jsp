...
<body>
	...
	<div class="wrapper-payment-form padding-20">
		...
		<form:form id="payment-form" class="padding-20"
			commandName="paymentForm" action="${validationAction}" method="POST">
			...
			<form:errors path="creditCardNumber" cssClass="error"></form:errors>
			<br>
			...
			<form:errors path="creditCardUserName" cssClass="error"></form:errors>
			<br>
			...
			<form:errors path="expirationMonth" cssClass="error"></form:errors>
			<br>
			...
			<form:errors path="expirationYear" cssClass="error"></form:errors>
			<br>
			<div class="text-align-center">
				<input type="submit" value="Payer le montant"
