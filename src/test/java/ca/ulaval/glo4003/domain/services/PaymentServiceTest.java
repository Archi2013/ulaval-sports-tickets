...
public class PaymentServiceTest {
	...
	public void when_cartContainsTickets_buyTicketsInCart_should_pay_the_tickets_in_cart()
		...
		when(
				creditCardFactory.createCreditCard(creditCardType, CREDIT_CARD_NUMBER, SECURITY_CODE,
						CREDIT_CARD_USERNAME, EXPIRATION_MONTH, EXPIRATION_YEAR)).thenReturn(creditCard);
		when(cartService.getCumulativePrice()).thenReturn(PRICE);

		paymentService.buyTicketsInCart(creditCardType, CREDIT_CARD_NUMBER, SECURITY_CODE, CREDIT_CARD_USERNAME,
