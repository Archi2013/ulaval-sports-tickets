...
public class SportUrlMappingTest {
	...
	@Test
	public void with_a_existing_sport_getSportUrl_should_return_the_url() {
		String sportUrl = SportUrlMapper.getSportUrl(SPORT_NAME);
		assertEquals(sportUrl, SPORT_URL);
	}
	
	@Test
	public void with_a_existing_sport_getSportName_should_return_the_name() {
		String sportName = SportUrlMapper.getSportName(SPORT_URL);
		assertEquals(sportName, SPORT_NAME);
	}
	
	@Test
	public void with_a_existing_sport_containing_spaces_getSportUrl_should_return_the_url() {
		String sportUrl = SportUrlMapper.getSportUrl(SPORT_NAME_SPACES);
		assertEquals(sportUrl, SPORT_URL_SPACES);
	}
	
	@Test
	public void with_a_existing_sport_containing_spaces_getSportName_should_return_the_name() {
		String sportName = SportUrlMapper.getSportName(SPORT_URL_SPACES);
		assertEquals(sportName, SPORT_NAME_SPACES);
	}
	
	@Test
	public void with_a_existing_sport_containing_accents_getSportUrl_should_return_the_url() {
		String sportUrl = SportUrlMapper.getSportUrl(SPORT_NAME_ACCENTS);
		assertEquals(sportUrl, SPORT_URL_ACCENTS);
	}
	
	@Test
	public void with_a_existing_sport_containing_accents_getSportName_should_return_the_name() {
		String sportName = SportUrlMapper.getSportName(SPORT_URL_ACCENTS);
		assertEquals(sportName, SPORT_NAME_ACCENTS);
	}
	
	@Test(expected = RuntimeException.class)
	public void with_an_invalid_sport_name_getSportUrl_shoudl_raise_a_RuntimeException() {
		SportUrlMapper.getSportUrl(INVALID_SPORT_NAME);
	}
	
	@Test(expected = RuntimeException.class)
	public void with_an_invalid_sport_url_getSportName_raise_a_RuntimeException() {
